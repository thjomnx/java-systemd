...
public class SELinuxContextTest {

    @Test(description="Tests parameterized constructor.")
    public void testConstructor() {
        SELinuxContext instance = new SELinuxContext(new Object[] { true, "foo" });

        Assert.assertNotNull(instance);
        Assert.assertTrue(instance.isPrefixed());
        Assert.assertEquals(instance.getUserData(), "foo");
    }
    ...
    public void testConstructorFailures() {
        ...
        try {
            new SELinuxContext(new Object[0]);
        }
        catch (Exception e) {
            exc = e;
        }
